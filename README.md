...
「设置 → 外观主题」可在八套皮肤间即点即换。六套带实拍背景照片和对应动效，另有两套纯色主题：

| 主题 | 画面 | 动效 |
| --- | --- | --- |
| 常春藤 | 常春藤叶丛 | 藤蔓沿窗口边缘生长、长叶、随风轻摆 |
| 红旗 | 长城蓝天 | 五星红旗在横幅里飘扬 + 金色微粒 |
| 星海 | 哈勃望远镜拍摄的星云 | 多层视差星野漂移 + 流星（深色） |
| 樱花 | 樱花实拍 | 花瓣飘落、自转、远近视差 |
| 赛博 | 赛博朋克霓虹长廊 | 霓虹辉光呼吸 + 扫描光带（深色） |
| 雪山 | 珠峰与深蓝天 | 云雾分层横向缓移 |
| 清绿 | 纯色（品牌淡绿） | 无动效，安静干净 |
...
- 图片类主题的素材都取自**公有领域 / CC0**（除赛博是一张 CC0 数字绘画外，其余均为实拍照片），逐张来源见 [`assets/themes/CREDITS.md`](assets/themes/CREDITS.md)。
